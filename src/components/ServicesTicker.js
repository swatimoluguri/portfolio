...
import gsap from "gsap"; // Make sure to import gsap in your project
...
const ServicesTicker = () => {
  ...
  useEffect(() => {
    ...
    const lines = ticker.querySelectorAll(".stb_line_single");
    lines.forEach((line) => {
  ...
  return (
    <div className="services-ticker-block" ref={tickerRef}>
